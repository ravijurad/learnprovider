...
class CategoryProvider with ChangeNotifier {
  ...
  bool _isDummyDesktop(BuildContext context) =>
      MediaQuery.of(context).size.width < 1500;

  get forDesktop => _isDummyDesktop;
  ...
  get index => _index;
  get isContent => _isContent;
  get isCategory => _isCategory;
  ...
  void notifyHover(bool value) {
    _notify = value;
    notifyListeners();
  }

  void settingHover(bool value) {
    _setting = value;
    notifyListeners();
  }

  void userNameHover(bool value) {
    _userName = value;
    notifyListeners();
  }
  ...
  get isAscending => _isAscending;
  get sortColumnIndex => _sortColumnIndex;
  ...
  void onSort(int columnIndex, bool ascending) {
    ...
    if (columnIndex == 0) {
      ...
      ascending
          ? progressList.sort((a, b) => b.name!.compareTo(a.name!))
          : progressList.sort((a, b) => a.name!.compareTo(b.name!));
      ascending
          ? filterList.sort((a, b) => b.name!.compareTo(a.name!))
          : filterList.sort((a, b) => a.name!.compareTo(b.name!));
    } else if (columnIndex == 1) {
      ascending
          ? categoryList.sort((a, b) => b.admin!.compareTo(a.admin!))
          : categoryList.sort((a, b) => a.admin!.compareTo(b.admin!));
      ascending
          ? progressList.sort((a, b) => b.admin!.compareTo(a.admin!))
          : progressList.sort((a, b) => a.admin!.compareTo(b.admin!));
      ascending
          ? filterList.sort((a, b) => b.admin!.compareTo(a.admin!))
          : filterList.sort((a, b) => a.admin!.compareTo(b.admin!));
    } else if (columnIndex == 3) {
      ascending
          ? categoryList.sort((a, b) => b.desc!.compareTo(a.desc!))
          : categoryList.sort((a, b) => a.desc!.compareTo(b.desc!));
      ascending
          ? progressList.sort((a, b) => b.desc!.compareTo(a.desc!))
          : progressList.sort((a, b) => a.desc!.compareTo(b.desc!));
      ascending
          ? filterList.sort((a, b) => b.desc!.compareTo(a.desc!))
          : filterList.sort((a, b) => a.desc!.compareTo(b.desc!));
    }
...
// CHIP LIST
  ...
  void inProgressList() {
    ...
    for (var element in categoryList) {
      if (element.status == "In Progress") progressList.add(element);
    }
    notifyListeners();
  }
  ...
  void addDummyItems(CategoryModel categoryModel) {
